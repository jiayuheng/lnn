function [cost,grad] = saecostlap(theta, visibleSize, hiddenSize, lambda, sparsityParam, beta, data,lap, L,lap2)
...
%% bp part 
d3 = -(data-a3).*sigmoidInv(z3)+lap2*V2*(L+L');
